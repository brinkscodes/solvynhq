import { BrandIdentityEditor } from "@/components/marketing/brand-identity-editor";
...
export const metadata = {
  title: "Solvyn - Brand Identity",
  description: "Brand identity and marketing context for Solvyn",
};
    ...
    <div className="flex min-h-screen bg-[var(--solvyn-bg-base)] font-[family-name:var(--font-inter)]">
      ...
      <main className="flex-1 lg:ml-[232px]">
        <div className="mx-auto max-w-[960px] px-4 py-16 sm:px-8 sm:py-10 lg:py-10">
          <BrandIdentityEditor initialData={data} />
        </div>
      </main>
      <FloatingAgenda />
      <FloatingNotepad />
