    ...
    <>
      ...
      <div className="relative rounded-xl border border-[#EAE4D9] bg-white p-6 pb-8 shadow-sm">
        ...
        {activeTab === "proofPoints" && (
          <TabProofPoints
            data={data.proofPoints}
            update={update}
            editing={editing}
          />
        )}
        {/* Edit toggle — bottom-right of container */}
        <button
  ...
  return (
    <div className="space-y-5">
      <TabHeader
        ...
        description="What Solvyn is and how it fits in the market."
      />
      {editing ? (
        <>
  ...
  return (
    <div className="space-y-5">
      <TabHeader
        ...
        description="Who you're selling to and the problems you solve for them."
      />
      {editing ? (
        <>
...
function TabPersonas({
  ...
  return (
    <div className="space-y-5">
      <TabHeader
        title="Personas"
        description="Key buyer personas and what each cares about."
      />
      {editing ? (
        <>
          {data.map((row, i) => (
  ...
  return (
    <div className="space-y-5">
      <TabHeader
        ...
        description="What your customers struggle with before finding you."
      />
      {editing ? (
        <>
  ...
  return (
    <div className="space-y-5">
      <TabHeader
        ...
        description="Who you're up against and how they fall short."
      />
      {editing ? (
        <>
  ...
  return (
    <div className="space-y-5">
      <TabHeader
        ...
        description="What makes Solvyn uniquely better."
      />
      {editing ? (
        <>
...
function TabObjections({
  ...
  return (
    <div className="space-y-5">
      <TabHeader
        title="Objections & Anti-Personas"
        description="Common pushback and who isn't a good fit."
      />
      {editing ? (
        <>
  ...
  return (
    <div className="space-y-5">
      <TabHeader
        ...
        description="The four forces that drive or block switching behavior."
      />
      {editing ? (
        <>
  ...
  return (
    <div className="space-y-5">
      <TabHeader
        ...
        description="Exact words and phrases to use (and avoid) in messaging."
      />
      {editing ? (
        <>
...
function TabVoice({
  ...
  return (
    <div className="space-y-5">
      <TabHeader
        title="Brand Voice"
        description="How Solvyn sounds across all communications."
      />
      {editing ? (
        <>
